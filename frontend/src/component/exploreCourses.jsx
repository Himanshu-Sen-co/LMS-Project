...
function ExploreCourses() {
  ...
  return (
    <div className='w-[100vw] min-h-[50vh] lg:h-[60vh] flex items-center justify-center flex-col lg:flex-row gap-4 px-[30px] '>
        {/* left/top side div */}
        <div className='w-[100%] lg:w-[350px] lg:h-[100%] h-[400px] flex flex-col items-start justify-center gap-1 md:px-[40px] px-[20px] '>
            ...
            <p className='text-[17px]'>Discover a variety of courses designed to help you achieve your learning goals. Whether you're looking to enhance your skills or explore new topics, we have something for everyone.</p>
            <button className='mt-[35px] px-[20px] py-[10px] border-2 bg-black flex gap-2 text-white border-white rounded-[10px] text-[18px] font-light cursor-pointer' onClick={() => navigate("allCourses")} >Browse Courses<SiViaplay className='w-[30px] h-[30px] fill-white '/></button>
        </div>
        ...
        <div className='w-[720px] max-w-[90%] lg:h-[300px] md:min-h-[300px] flex items-center justify-center lg:gap-[60px] gap-[50px] flex-wrap mb-[50px] lg:mb-[0px] '>
            ...
            <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center '>
                <div className='w-[100px] h-[90px] bg-[#fbd9fb] rounded-lg flex items-center justify-center '>
                <TbFileAnalytics className='w-[50px] h-[50px] text-[#6d6c6c] ' />
                </div>
                Data Analytics
            </div>
            <div className='w-[100px] h-[130px] font-light text-[13px] flex flex-col gap-3 text-center '>
