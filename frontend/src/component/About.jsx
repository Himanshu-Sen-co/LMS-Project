...
function About() {
  return (
    <div className='w-[100vw] lg:h-[70vh] min-h-[50vh] flex flex-wrap items-center justify-center gap-2 mb-[40px] '>
        {/* for image */}
        <div className='lg:w-[40%] md:w-[80%] w-[100%] h-[100%] flex items-center justify-center relative '>
            ...
            <div className='max-w-[350px] mx-auto p-4 absolute top-[35%] left-[55%] '>
                <video src={video} controls autoPlay loop className='w-full rounded-xl shadow-lg border-2 border-white ' />
            </div>
        </div>
        {/* for about info */}
        <div className='lg:w-[50%] md:w-[70%] w-[100%] h-[100%] flex items-start justify-center flex-col px-[35px] md:px-[80px] '>
            <div className='text-[20px] flex items-center justify-center gap-[20px] '>About Us <TfiLayoutLineSolid className='w-[40px] h-[40px]' /></div>
            ...
            <div className='w-[100%] lg:w-[60%] '>
                <div className='mt-[40px] flex items-center justify-between '>
                    <div className='flex items-center justify-center gap-[10px] '><BsFillPatchCheckFill className='w-[20px] h-[20px]' />
                        Simplified Learning 
                    </div>
                    <div className='flex items-center justify-center gap-[10px] '><BsFillPatchCheckFill className='w-[20px] h-[20px]' />
                        Expert Trainers 
